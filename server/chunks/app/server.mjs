...
var EMPTY_OBJ_1 = shared_cjs_prod.EMPTY_OBJ = EMPTY_OBJ;
...
var extend_1 = shared_cjs_prod.extend = extend;
shared_cjs_prod.generateCodeFrame = generateCodeFrame;
shared_cjs_prod.getGlobalThis = getGlobalThis;
var hasChanged_1 = shared_cjs_prod.hasChanged = hasChanged;
...
var isMap_1 = shared_cjs_prod.isMap = isMap;
...
var isSet_1 = shared_cjs_prod.isSet = isSet;
...
var remove_1 = shared_cjs_prod.remove = remove;
...
const components = {};
function components_370dfe72(nuxtApp) {
...
const vueuseHead_2c9958c5 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_4e498a8e = defineNuxtPlugin((nuxtApp) => {
...
function doWatch(source, cb, { immediate, deep, flush: flush2, onTrack, onTrigger } = EMPTY_OBJ_1) {
  ...
  if (isRef_1(source)) {
    getter = () => source.value;
    forceTrigger = isShallow_1(source);
  } else if (isReactive_1(source)) {
    getter = () => source;
    deep = true;
  } else if (isArray_1(source)) {
    isMultiSource = true;
    forceTrigger = source.some(isReactive_1);
    getter = () => source.map((s) => {
      if (isRef_1(s)) {
        return s.value;
      } else if (isReactive_1(s)) {
        return traverse(s);
      } else if (isFunction_1(s)) {
        return callWithErrorHandling(s, instance, 2);
      } else ;
    });
  } else if (isFunction_1(source)) {
    if (cb) {
  ...
  const job = () => {
    ...
    if (cb) {
      ...
      if (deep || forceTrigger || (isMultiSource ? newValue.some((v, i) => hasChanged_1(v, oldValue[i])) : hasChanged_1(newValue, oldValue)) || false) {
        if (cleanup) {
          cleanup();
        }
  ...
  const effect2 = new ReactiveEffect_1(getter, scheduler2);
  if (cb) {
    if (immediate) {
      job();
    } else {
  ...
  return () => {
    ...
    if (instance && instance.scope) {
      remove_1(instance.scope.effects, effect2);
    }
  };
}
function instanceWatch(source, value, options) {
  const publicThis = this.proxy;
  const getter = isString_1(source) ? source.includes(".") ? createPathGetter(publicThis, source) : () => publicThis[source] : source.bind(publicThis, publicThis);
  let cb;
...
function traverse(value, seen) {
  if (!isObject_1(value) || value["__v_skip"]) {
    return value;
  }
  ...
  } else if (isSet_1(value) || isMap_1(value)) {
    value.forEach((v) => {
      traverse(v, seen);
    });
...
function defineComponent(options) {
  return isFunction_1(options) ? { setup: options, name: options.name } : options;
}
...
function mergeDataFn(to, from) {
  ...
  return function mergedDataFn() {
    return extend_1(isFunction_1(to) ? to.call(this, this) : to, isFunction_1(from) ? from.call(this, this) : from);
  };
}
...
function mergeObjectOptions(to, from) {
  return to ? extend_1(extend_1(/* @__PURE__ */ Object.create(null), to), from) : from;
}
function mergeWatchOptions(to, from) {
  ...
  if (!from)
    return to;
  const merged = extend_1(/* @__PURE__ */ Object.create(null), to);
  for (const key in from) {
...
const publicPropertiesMap = extend_1(/* @__PURE__ */ Object.create(null), {
  $: (i) => i,
  $el: (i) => i.vnode.el,
  $data: (i) => i.data,
  $props: (i) => i.props,
...
function getExposeProxy(instance) {
  if (instance.exposed) {
    return instance.exposeProxy || (instance.exposeProxy = new Proxy(proxyRefs_1(markRaw_1(instance.exposed)), {
      get(target, key) {
        if (key in target) {
          return target[key];
...
const _imports_0 = joinURL(NUXT_BASE, NUXT_CONFIG.app.buildAssetsDir, "/__NUXT_BASE__/neko.3ebbdfd3.jpg".replace("/__NUXT_BASE__", ""));
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "space-y-12" }, _attrs))}><img class="w-24 mx-auto rounded-full" width="512" height="512"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="kazuyan icon"><div><h1 class="text-4xl tracking-wider">\u5C0F\u68EE \u4E00\u8F1D</h1><p class="text-lg tracking-wider">Kazuki Komori</p></div><div class="tracking-wider"><p> \u306F\u3058\u3081\u307E\u3057\u3066\uFF01\u5C0F\u68EE \u4E00\u8F1D <span class="text-xs">(\u3053\u3082\u308A\u304B\u305A\u304D)</span> \u3067\u3059\u3002\u30CD\u30C3\u30C8\u4E0A\u3067\u306F &quot;kazuyan&quot; \u3068\u540D\u4E57\u3063\u3066\u3044\u307E\u3059\u3002 </p><br><p>\u5927\u962A\u5728\u4F4F\u3067\u3001\u30B3\u30FC\u30C9\u3092\u66F8\u304F\u3053\u3068\u3092\u751F\u6D3B\u306E\u697D\u3057\u307F\u3068\u3057\u3066\u3044\u307E\u3059\u3002</p><br><p>\u30D5\u30ED\u30F3\u30C8\u30A8\u30F3\u30C9\u5468\u308A\u3092\u4E2D\u5FC3\u306B, kaggle \u306A\u3069\u30C7\u30FC\u30BF\u5206\u6790\u306B\u3082\u8208\u5473\u3092\u3082\u3063\u3066\u53D6\u308A\u7D44\u3093\u3067\u3044\u307E\u3059\u3002</p><br><p>Vue.js \u304C\u597D\u304D\u3067, 2022\u5E74 Vue.js JP \u306E\u30B3\u30A2\u30E1\u30F3\u30D0\u30FC\u3068\u3057\u3066\u6D3B\u52D5\u3057\u3066\u3044\u307E\u3059\u3002</p><br><p>\u540C\u5FD7\u793E\u5927\u5B66\u30FB\u30A8\u30F3\u30B8\u30CB\u30A2\u56E3\u4F53 Do&#39;er \u5275\u8A2D\u8005\u30FB\u4EE3\u8868\u3068\u3057\u3066\u30A8\u30F3\u30B8\u30CB\u30A2\u306E\u80B2\u6210\u306B\u8208\u5473\u3092\u6301\u3063\u3066\u3044\u307E\u3059\u3002</p></div></section>`);
}
const _sfc_setup$a = _sfc_main$a.setup;
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/SecProfile.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const SecProfile = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$9]]);
const careers = [
  {
    id: 1,
    company_name: "chatbox.inc",
    detail: "Nuxt.js \u3092\u7528\u3044\u305F\u30D5\u30ED\u30F3\u30C8\u30A8\u30F3\u30C9\u958B\u767A\u30FBPHP Laravel \u3067\u306E\u30B5\u30FC\u30D0\u30FC\u30B5\u30A4\u30C9\u958B\u767A",
    date: "2019/11 ~ 2022/02"
  },
  {
    id: 2,
    company_name: "tambourine inc.",
    detail: "Node.js TypeScript \u3092\u7528\u3044\u305F slack \u30A2\u30D7\u30EA\u306E\u958B\u767A",
    date: "2020/03"
  },
  {
    id: 3,
    company_name: "e-Seikatsu Co., Ltd.",
    detail: "Vue.js \u3092\u7528\u3044\u305F\u4E0D\u52D5\u7523\u30A2\u30D7\u30EA\u958B\u767A",
    date: "2020/08"
  },
  {
    id: 4,
    company_name: "CyberAgent, Inc.",
    detail: "\u30D5\u30ED\u30F3\u30C8\u30A8\u30F3\u30C9\u958B\u767A\u578B\u30A4\u30F3\u30BF\u30FC\u30F3\\n\u30CF\u30C3\u30AB\u30BD\u30F3\u578B\u306EEC\u30B5\u30A4\u30C8\u958B\u767A",
    date: "2021/03"
  },
  {
    id: 5,
    company_name: "Amazon Web Services, Inc.",
    detail: "AWS \u4E0A\u3067\u52D5\u4F5C\u3059\u308Bweb\u30A2\u30D7\u30EA\u306E\u30C8\u30E9\u30D6\u30EB\u30B7\u30E5\u30FC\u30C6\u30A3\u30F3\u30B0",
    date: "2021/08"
  },
  {
    id: 6,
    company_name: "DeNA Co., Ltd.",
    detail: "\u3010\u77ED\u671F\u3011\u30BD\u30D5\u30C8\u30A6\u30A7\u30A2\u30A8\u30F3\u30B8\u30CB\u30A2\u30EA\u30F3\u30B0 \u30A4\u30F3\u30BF\u30FC\u30F3\\n\u9AD8\u30C8\u30E9\u30D5\u30A3\u30C3\u30AF\u306A\u72B6\u6CC1\u3092\u60F3\u5B9A\u3057\u305F\u958B\u767A",
    date: "2021/09"
  },
  {
    id: 7,
    company_name: "NTT DATA Corporation",
    detail: "Terrafrom \u3092\u7528\u3044\u305F AWS \u81EA\u52D5\u69CB\u7BC9",
    date: "2021/09"
  },
  {
    id: 8,
    company_name: "Lightblue Technology",
    detail: "ML \u3092\u7528\u3044\u305F\u7570\u5E38\u691C\u77E5\u624B\u6CD5\u306E\u691C\u8A0E",
    date: "2022/02"
  }
];
const json$3 = {
...
const _sfc_main$9 = defineComponent({
  name: "SecCareer",
  setup() {
    const careers2 = json$3.careers;
    const blankReplacer = (text) => {
      text = text.replace(/\\n/g, "<br>");
      return text;
    };
    return { careers: careers2, blankReplacer };
  }
});
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "space-y-6" }, _attrs))}><h2 class="text-xl">\u30AD\u30E3\u30EA\u30A2</h2><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.careers, (career) => {
    _push(`<div class="tracking-wide"><p class="text-lg">${serverRenderer.exports.ssrInterpolate(career.company_name)} <span class="text-sm">(${serverRenderer.exports.ssrInterpolate(career.date)})</span></p><p class="text-sm">${_ctx.blankReplacer(career.detail)}</p></div>`);
  });
  _push(`<!--]--></section>`);
}
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/SecCareer.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const SecCareer = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$8]]);
const publicatios = [
  {
    id: 1,
    title: "\u30B5\u30DD\u30FC\u30BF\u30FC\u30BA\u30FB\u30B5\u30DE\u30FC\u30CF\u30C3\u30AB\u30BD\u30F3 vol.2. \u512A\u79C0\u8CDE",
    detail: "\u30D0\u30FC\u30C1\u30E3\u30EB\u80CC\u666F\u4F5C\u6210\u30A2\u30D7\u30EA Profill \u306E\u958B\u767A",
    tech: "Nuxt.js / Tailwind",
    date: "2020/08",
    link: "https://profill-app.net"
  },
  {
    id: 2,
    title: "Open Hack U 2020 Online vol.4. \u512A\u79C0\u8CDE",
    detail: "\u8CB8\u3057\u5FD8\u308C, \u8FD4\u3057\u5FD8\u308C\u3092\u9632\u6B62\u3059\u308B\u30A2\u30D7\u30EA\u306E\u958B\u767A",
    tech: "React / LIFF / Python / Flask / Postgress / AWS",
    date: "2021/03",
    link: "https://hacku.yahoo.co.jp/hacku2020online4"
  },
  {
    id: 3,
    title: "\u30B5\u30A4\u30D0\u30FC\u30A8\u30FC\u30B8\u30A7\u30F3\u30C8 Tech Challenge \u512A\u79C0\u8CDE",
    detail: "\u97F3\u58F0\u3067\u52D5\u4F5C\u3059\u308BEC\u30B5\u30A4\u30C8\u306E\u958B\u767A",
    tech: "Nuxt.js / Tailwind",
    date: "2021/03",
    link: "https://speakerdeck.com/kazuyan/ca-tech-challenge-e4253060-f667-4faa-89fe-c09e1a94a02f"
  },
  {
    id: 4,
    title: "\u6280\u80B2CAMP vol.13. \u52AA\u529B\u8CDE",
    detail: "\u30A8\u30F3\u30B8\u30CB\u30A2\u5411\u3051SNS\u30A2\u30D7\u30EA\u306E\u958B\u767A",
    tech: "Next.js / Tailwind / Golang / gin / Heroku",
    date: "2022/01",
    link: ""
  },
  {
    id: 5,
    title: "\u7D4C\u55B6\u79D1\u5B66\u7CFB\u7814\u7A76\u90E8\u4F1A\u9023\u5408\u5354\u8B70\u4F1A\u4E3B\u50AC\u4EE4\u548C\uFF13\u5E74\u5EA6\u30C7\u30FC\u30BF\u89E3\u6790\u30B3\u30F3\u30DA\u30C6\u30A3\u30B7\u30E7\u30F3\u95A2\u897F\u4E88\u9078 \u6700\u512A\u79C0\u8CDE",
    detail: "\u691C\u7D22\u30C7\u30FC\u30BF\u306E\u30C8\u30D4\u30C3\u30AF\u5206\u6790\u3068\u60C5\u5831\u306E\u691C\u7D22\u652F\u63F4 \uFF0Dmamari\u30A2\u30D7\u30EA\u306B\u304A\u3051\u308B\u65B0\u6A5F\u80FD\u306E\u63D0\u6848\uFF0D",
    tech: "Python / R",
    date: "2022/02",
    link: "https://jasmac-j.jimdofree.com"
  },
  {
    id: 6,
    title: "\u7D4C\u55B6\u79D1\u5B66\u7CFB\u7814\u7A76\u90E8\u4F1A\u9023\u5408\u5354\u8B70\u4F1A\u4E3B\u50AC\u4EE4\u548C\uFF13\u5E74\u5EA6\u30C7\u30FC\u30BF\u89E3\u6790\u30B3\u30F3\u30DA\u30C6\u30A3\u30B7\u30E7\u30F3\u5168\u56FD\u5927\u4F1A \u30B3\u30CD\u30D2\u30C8\u8CDE",
    detail: "\u691C\u7D22\u30C7\u30FC\u30BF\u306E\u30C8\u30D4\u30C3\u30AF\u5206\u6790\u3068\u60C5\u5831\u306E\u691C\u7D22\u652F\u63F4 \uFF0Dmamari\u30A2\u30D7\u30EA\u306B\u304A\u3051\u308B\u65B0\u6A5F\u80FD\u306E\u63D0\u6848\uFF0D",
    tech: "Python / R",
    date: "2022/03",
    link: "https://jasmac-j.jimdofree.com"
...
const _sfc_main$8 = defineComponent({
  name: "SecPublication",
  setup() {
    const publications = json$2.publicatios;
    return { publications };
  }
});
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "space-y-4" }, _attrs))}><h2 class="text-xl">\u53D7\u8CDE\u6B74</h2><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.publications, (publication) => {
    _push(`<div class="tracking-wider"><p class="mb-1">${serverRenderer.exports.ssrInterpolate(publication.title)} <span class="text-sm">(${serverRenderer.exports.ssrInterpolate(publication.date)})</span></p><p class="text-sm">${serverRenderer.exports.ssrInterpolate(publication.detail)}</p><p class="text-sm">${serverRenderer.exports.ssrInterpolate(publication.tech)}</p><a class="inline-block tracking-wide my-1 text-vue-green"${serverRenderer.exports.ssrRenderAttr("href", publication.link)}>${serverRenderer.exports.ssrInterpolate(publication.link)}</a></div>`);
  });
  _push(`<!--]--></section>`);
}
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/SecPublication.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const SecPublication = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$7]]);
const activities = [
  {
    title: "\u540C\u5FD7\u793E\u5927\u5B66 \u6587\u5316\u60C5\u5831\u5B66\u7814\u7A76\u79D1 \u7D71\u8A08\u79D1\u5B66\u7814\u7A76\u5BA4",
    role: "member"
  },
  {
    title: "Vue.js JP 2022",
    role: "Staff"
  },
  {
    title: "\u540C\u5FD7\u793E\u5927\u5B66\u30A8\u30F3\u30B8\u30CB\u30A2\u30B5\u30FC\u30AF\u30EB Do'er",
    role: "\u4EE3\u8868"
  },
  {
    title: "\u30D3\u30B8\u30CD\u30B9\u30FB\u30A8\u30F3\u30B8\u30CB\u30A2\u30B5\u30FC\u30AF\u30EB Scholar",
    role: "ex-Tech Lead"
  }
];
const json$1 = {
...
const _sfc_main$7 = defineComponent({
  name: "SecActivity",
  setup() {
    const activities2 = json$1.activities;
    return { activities: activities2 };
  }
});
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "space-y-6" }, _attrs))}><h2 class="text-xl">\u6240\u5C5E</h2><div class="space-y-3"><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.activities, (act, idx_act) => {
    _push(`<p>${serverRenderer.exports.ssrInterpolate(act.title)} - ${serverRenderer.exports.ssrInterpolate(act.role)}</p>`);
  });
  _push(`<!--]--></div></section>`);
}
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/SecActivity.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const SecActivity = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$6]]);
const oss = [
  {
    title: "nuxt/nuxtjs.org",
    link: "https://github.com/nuxt/nuxtjs.org"
  },
  {
    title: "vitejs/docs-ja",
    link: "https://github.com/vitejs/docs-ja"
  },
  {
    title: "vue-a11y/vue-a11y.com",
    link: "https://github.com/vue-a11y/vue-a11y.com"
  }
];
const json = {
  oss
...
const _sfc_main$6 = defineComponent({
  name: "SecOss",
  setup() {
    const ossArr = json.oss;
    return { ossArr };
  }
});
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "space-y-5" }, _attrs))}><h2 class="text-xl">OSS</h2><div class="space-y-3"><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.ossArr, (oss2, idx_oss) => {
    _push(`<p><a${serverRenderer.exports.ssrRenderAttr("href", oss2.link)} target="_blank" class="text-vue-green tracking-wider">${serverRenderer.exports.ssrInterpolate(oss2.title)}</a></p>`);
  });
  _push(`<!--]--></div></section>`);
}
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/pages/SecOss.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const SecOss = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$5]]);
...
const routes = [
  {
    name: "index",
    path: "/",
    file: "/home/runner/work/my_intro/my_intro/pages/index.vue",
    children: [],
    meta,
...
const router_441400f4 = defineNuxtPlugin((nuxtApp) => {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]);
let entry;
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<header${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "max-w-screen-md mx-auto py-3 tracking-wide text-xl" }, _attrs))}><nav class="text-right space-x-5"><a class="duration-500 hover:opacity-90 opacity-60" href="https://github.com/kazuki-komori" target="_blank"> GitHub </a><a class="duration-500 hover:opacity-90 opacity-60" href="https://twitter.com/D_kazuyan" target="_blank"> Twitter </a></nav></header>`);
}
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_AppHeader = vue_cjs_prod.resolveComponent("AppHeader");
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "space-y-20 text-gray-700 dark:bg-slate-900 dark:text-slate-300" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_AppHeader, null, null, _parent));
  _push(`<div class="py-16">`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_SecProfile = vue_cjs_prod.resolveComponent("SecProfile");
  const _component_SecCareer = vue_cjs_prod.resolveComponent("SecCareer");
  const _component_SecPublication = vue_cjs_prod.resolveComponent("SecPublication");
  const _component_SecActivity = vue_cjs_prod.resolveComponent("SecActivity");
  const _component_SecOss = vue_cjs_prod.resolveComponent("SecOss");
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "max-w-screen-md mx-auto space-y-20" }, _attrs))}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_SecProfile, null, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_SecCareer, null, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_SecPublication, null, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_SecActivity, null, null, _parent));
  _push(serverRenderer.exports.ssrRenderComponent(_component_SecOss, null, null, _parent));
  _push(`</div>`);
}
